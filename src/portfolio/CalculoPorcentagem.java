...
public class CalculoPorcentagem extends JDialog {
	...
	public CalculoPorcentagem() {
		...
		JTextField txtCalculoPorcentagem;
		
		// Validação Porcentagem
				RestrictedTextField txtx = new RestrictedTextField(txtX, "0123456789");
				txtx.setLimit(3);

				// Validação Valor
				RestrictedTextField txty = new RestrictedTextField(txtY, "0123456789.");
				txty.setLimit(6);
				...
				// Validação SubTotal
				RestrictedTextField valortotal = new RestrictedTextField(txtValortotal, "0123456789.");
				valortotal.setLimit(6);
