...
public class Jokenpo extends JDialog {
	...
	public Jokenpo() {
		...
		setModal(true);
		setIconImage(Toolkit.getDefaultToolkit().getImage(portfolio.Jokenpo.class.getResource("/img/pedra.png")));
		...
		lblPedra.setIcon(new ImageIcon(portfolio.Jokenpo.class.getResource("/img/pedra.png")));
		lblPedra.setBounds(28, 11, 64, 64);
		getContentPane().add(lblPedra);
		
		JLabel lblPapel = new JLabel("");
		lblPapel.setBorder(null);
		lblPapel.setIcon(new ImageIcon(portfolio.Jokenpo.class.getResource("/img/papel.png")));
		lblPapel.setBounds(120, 11, 64, 64);
		getContentPane().add(lblPapel);
		
		JLabel lblTesoura = new JLabel("");
		lblTesoura.setBorder(null);
		lblTesoura.setIcon(new ImageIcon(portfolio.Jokenpo.class.getResource("/img/tesoura.png")));
		lblTesoura.setBounds(212, 11, 64, 64);
		getContentPane().add(lblTesoura);
		
		JButton btnPow = new JButton("");
		btnPow.setIcon(new ImageIcon(portfolio.Jokenpo.class.getResource("/img/jokenpo2.png")));
		...
		lblPc = new JLabel("");
		lblPc.setIcon(new ImageIcon(portfolio.Jokenpo.class.getResource("/img/pc.png")));
